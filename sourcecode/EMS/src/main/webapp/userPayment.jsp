                    ...
                    <table class="table table-bordered table-striped">
                        <tbody>
                            <tr style="display: none;">
                                <td>Id</td>
                                <td style="display: none;"><input type="hidden" name="employeeId" value="<%= employee.getId() %>"/></td>
                            </tr>
                            <tr style="display: none;">
                                <td>PayId</td>
                                <td style="display: none;"><input type="hidden" name="paymentId" value="<%= pay.getId() %>"/></td>
                            </tr>
                            <tr>
                                <td>Full Name</td>
