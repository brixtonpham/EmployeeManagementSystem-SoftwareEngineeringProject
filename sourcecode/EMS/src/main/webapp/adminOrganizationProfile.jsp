...
<body>
    <div class="container">
        ...
        <% if (request.getAttribute("employee") != null && request.getAttribute("profile") != null) { 
            ...
            OrganizationProfile profile = (OrganizationProfile) request.getAttribute("profile"); %>
        <div class="form-container">
            <h2><%= employee.getFirstname() %> <%= employee.getLastname() %> Profile Details</h2>
            <form action="OrganizationProfiles" method="post">
                <input type="hidden" name="employeeId" value="<%= employee.getId() %>">
                <input type="hidden" name="profileId" value="<%= profile.getId() %>">
                <input type="hidden" name="supervisor" value="<%= employee.getUsername() %> <%= employee.getPassword() %>">
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="role" value="<%= profile.getRole() %>"></td>
                        </tr>
                        <tr>
                            <td>Division</td>
                            <td><input type="text" name="division" value="<%= profile.getDivisionName() %>"></td>
                        </tr>
                        <tr>
                            <td>Supervisor</td>
